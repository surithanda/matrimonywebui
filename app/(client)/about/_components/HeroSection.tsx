...
const HeroSection = () => {
  return (
    <BaseHeroSection
      backgroundImage="/images/aboutPageHeroImage.jpg"
    ...
    >
      ...
      <div data-aos='fade-right' className=" w-full sm:w-full md:w-[500px] lg:w-full space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-[20px]">
        ...
        <p
          className="text-lg md:text-lg lg:text-xl 2xl:text-2xl text-white/90 max-w-xl"
          style={{ fontFamily: '"BR Cobane", sans-serif', fontWeight:400, fontStyle:'normal', lineHeight:'normal', letterSpacing:'-0.54px' }}
        >
