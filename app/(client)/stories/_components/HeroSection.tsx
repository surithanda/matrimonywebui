...
const HeroSection = () => {
  return (
    <BaseHeroSection
      backgroundImage="/images/couple2.jpg"
    ...
    >
      <div className=" w-full sm:w-full md:w-[500px] lg:w-full space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-[20px]">
        <h1 className="BRCobane64600 text-start text-5xl sm:text-3xl md:text-5xl lg:text-6xl leading-tight sm:leading-tight md:leading-snug">
