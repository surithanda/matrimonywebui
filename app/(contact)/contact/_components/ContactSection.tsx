  ...
  return (
    <section className="flex flex-col px-4 sm:px-6 md:px-10 lg:px-20 w-full">
      <div className="flex flex-col lg:flex-row items-center justify-around w-full gap-10  px-4 sm:px-6 lg:px-12 py-20">
        {/* Left Section */}
        <div className="flex flex-col lg:w-1/1 text-center lg:text-left">
          <p className="BRCobane56600 text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-gray-800 mb-4">
        ...
        {/* Right Section (Form) */}
        <div className="bg-white shadow-2xl shadow-gray-300/50 rounded-2xl w-full max-w-3xl p-6 sm:p-8 border">
      ...
      <div className="bg-white shadow-lg border py-10 mt-16 mb-4 md:mb-5 relative flex flex-col md:flex-row items-center justify-between gap-10 w-full rounded-2xl overflow-hidden">
