...
const Footer = () => {
  return (
    <footer className="footer bg-white flex flex-col items-center justify-center gap-[50px] md:p-[50px_100px_20px_100px] relative">
      <p>
      ...
      <p className="w-full text-center BRCobane16400">
        © 2024 Chaturvarnam Matrimony Services. All rights reserved.
      </p>
    </footer>
  );
};
