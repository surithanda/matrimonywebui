  ...
  return (
    <div className="dashboard-background px-4 md:px-[120px] md:pt-8 flex flex-col items-center md:gap-8 h-[90vh] relative">
      ...
      <Image
        src={lantern}
        alt="lantern"
        className="hidden md:block md:h-[300px] w-auto absolute -top-3 left-[50px] md:left-[30px] lg:left-[50px]"
      />
      <Image
        src={lantern}
        alt="lantern"
        className="hidden md:block md:h-[400px] w-auto absolute -top-4 right-[50px] md:right-[30px] lg:right-[50px] scale-x-[-1]"
      />
