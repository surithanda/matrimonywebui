import ambitionmarriage from "@/public/images/weeding-pose-husband-wife-love-professional-photography.jpg";
import modernwedding from "@/public/images/ritual-with-coconut-leaves-traditional-hindu-wedding-ceremony.jpg";
import weddingproposal from "@/public/images/traditional-indian-wedding-ceremony-groom-holding-hand-bride-hand.jpg";
...
const WeddingWisdomSection = () => {
  return (
    <section className="text-center py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 relative overflow-hidden">
      ...
      {/* Main heading */}
      <h2 className=" mb-8 sm:mb-10 md:mb-12 text-2xl sm:text-3xl md:text-4xl xl:text-xl 2xl:text-6xl leading-tight px-4 sm:px-0 font-bold">
        Wedding Wisdom:
        <br />
